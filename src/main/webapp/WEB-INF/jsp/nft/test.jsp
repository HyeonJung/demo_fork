...
<head>
    ...
    <title>Bigdragon Fire</title>
    <script src="/kks/config2.js"></script>
    <script src="/kks/mintScript2.js"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/caver-js/1.6.1/caver.min.js"></script>d
</head>
